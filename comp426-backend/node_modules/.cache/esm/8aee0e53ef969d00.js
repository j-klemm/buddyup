let Store,path,fs,debug;_ef9‍.w("data-store",[["default",["Store"],function(v){Store=v}]]);_ef9‍.w("path",[["default",["path"],function(v){path=v}]]);_ef9‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_ef9‍.w("debug",[["default",["debug"],function(v){debug=v}]]);
